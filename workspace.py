...
def TestBenchmark(net, warmup_runs, main_runs, run_individual):
    tup = (StringifyNetName(net), warmup_runs, main_runs, run_individual)
    return CallWithExceptionIntercept(
        BenchmarkNet,
        C.Workspace.current._last_failed_op_net_position,
        GetNetName(net),
	StringifyNetName(net), warmup_runs, main_runs, run_individual,
        )
